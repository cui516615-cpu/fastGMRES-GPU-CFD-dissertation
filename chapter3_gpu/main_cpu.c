...
int main(int argc, char **args) {
    ...
    printf("[CPU Sandbox] Robust Benchmarking Started...\n");
    ...
    printf("[CPU Sandbox] Performing %d Warm-up runs to warm cache...\n", n_warmup);
    for(int i = 0; i < n_warmup; i++) {
        VecSet(x, 0.0);
        KSPSolve(ksp, b, x);
    }

    printf("[CPU Sandbox] Performing %d Benchmark runs...\n", n_runs);
    ...
    printf("\n======================================================\n");
    printf("📊 [Robust CPU Performance Benchmark]\n");
    printf("   - Iterations        : %d\n", its);
